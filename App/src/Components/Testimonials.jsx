...
const Testimonials = () => {
    ...
    return (
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
            ...
            {/* gradient fade edges */}
            <div className="absolute left-0 top-0 bottom-0 w-16 md:w-28 bg-gradient-to-r from-slate-900 to-transparent z-10"></div>
            <div className="absolute right-0 top-0 bottom-0 w-16 md:w-28 bg-gradient-to-l from-slate-900 to-transparent z-10"></div>
