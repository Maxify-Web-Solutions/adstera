        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-2">
              <Link to="/" className="text-gray-300 hover:text-white hover:bg-blue-500/30 px-4 py-2 rounded transition">
                Home
              </Link>

              <Link to="/dashboard" className="text-gray-300 hover:text-white hover:bg-blue-500/30 px-4 py-2 rounded transition">
                Dashboard
              </Link>

              <Link to="/profile" className="text-gray-300 hover:text-white hover:bg-blue-500/30 px-4 py-2 rounded transition">
                Profile
              </Link>
