...
const Footer = () => {
    return (
        <footer className="bg-gray-50 dark:bg-slate-950 text-slate-500 dark:text-slate-300 py-12 border-t border-gray-200 dark:border-slate-800">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li><Link to="/AboutUs" className="hover:text-indigo-400 transition">About Us</Link></li>
                        ...
                        <li><Link to="/contactUs" className="hover:text-indigo-400 transition">Contact</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li><Link to="/privacy-pollicy" className="hover:text-indigo-400 transition">Privacy Policy</Link></li>
                        <li><Link to="/termsOfservice" className="hover:text-indigo-400 transition">Terms of Service</Link></li>
                        <li><Link to="/cookiePollicy" className="hover:text-indigo-400 transition">Cookie Policy</Link></li>
                    </ul>
                </div>
            </div>
