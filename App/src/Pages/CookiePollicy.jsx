    ...
    return (
        <div className="min-h-screen w-full dark:bg-slate-900 dark:text-gray-300 transition-colors duration-300 bg-gray-50 text-gray-900">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 md:py-20">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">What Are Cookies</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">How We Use Cookies</h2>
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Third-Party Cookies</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Managing Cookies</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Updates to This Policy</h2>
                <p className="mb-4">
