    ...
    return (
        <div className="min-h-screen w-full bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-gray-300 transition-colors duration-300">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 md:py-20">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">Use of Service</h2>
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">User Accounts</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">Payments & Subscriptions</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">Prohibited Activities</h2>
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">Limitation of Liability</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">Termination</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                    We reserve the right to suspend or terminate accounts that violate
                    these Terms of Service or misuse the platform.
                </p>

                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">Changes to Terms</h2>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-white mt-10 mb-4">Contact</h2>
