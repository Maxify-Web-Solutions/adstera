    ...
    return (
        <div className="min-h-screen w-full bg-slate-900 text-gray-300">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 md:py-20">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Information We Collect</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">How We Use Your Information</h2>
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Cookies</h2>
                <p className="mb-4">
                    Our website may use cookies and similar tracking technologies to enhance user
                    experience and analyze website traffic.
                </p>

                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Third-Party Services</h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Data Security</h2>
                <p className="mb-4">
                    We take reasonable measures to protect your information from unauthorized
                    access, misuse, or disclosure.
                </p>

                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Changes to This Policy</h2>
                <p className="mb-4">
                    We may update this Privacy Policy from time to time. Any changes will be
                    posted on this page.
                </p>

                <h2 className="text-xl md:text-2xl font-semibold text-white mt-10 mb-4">Contact Us</h2>
                <p>
