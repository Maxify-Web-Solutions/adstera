    ...
    return (
        <header className="sticky top-0 z-50 w-full h-16 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-700 px-4 md:px-8 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-6">
                ...
                <button
                    onClick={() =>
                        navigate("/dashboard/websites?openModal=true")
                    }
                ...
                {/* Desktop Balance */}
                <div className="hidden md:flex items-center gap-2 px-4 py-2 rounded-lg bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 font-semibold">
                    <span>Balance:</span>
