...
<div className="mb-4 relative overflow-hidden rounded-3xl border border-emerald-500/20 bg-gradient-to-br from-emerald-500/10 via-slate-900 to-slate-900 p-5 shadow-xl">

  {/* Glow */}
  <div className="absolute -top-10 -right-10 w-40 h-40 bg-emerald-400/10 blur-3xl rounded-full"></div>
  ...
  <div className="relative z-10">
    ...
    <div className="flex items-center justify-between gap-4 flex-wrap">
      ...
      <div>
        ...
        <p className="text-[11px] uppercase tracking-[0.25em] text-emerald-400/70 font-semibold mb-2">
          Withdrawal Summary
        </p>
